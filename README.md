...
|------|------|-------------|--------|
| **Frontend** | `front-chatgpt/` | UI Tabacman IA, login, chat, usuarios, carga docs | 5173 |
...
| **WhatsApp** | `whatsapp/` | API WhatsApp (QR, status, webhooks) | 3000 |
